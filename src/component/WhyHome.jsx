        ...
        <div className='py-20 px-3 bg-red-100 dark:bg-red-950'>
            ...
            <div className='xl:max-w-[1000px]   mx-auto my-12  whyimg'>
                <div className='py-12 w-full h-full custom-bg rounded-3xl  flex flex-col justify-center items-center text-neutral-50 dark:text-neutral-300 '>
                    ...
                    <p className='text-sm w-[80%] text-center leading-6 mt-5'>Caddesk Hyderabad, a leading institute, offers CAD, CAM and CAE software courses. With experienced trainers and advanced software, students receive practical, industry-standard education. Students also receive placement assistance. Caddesk Hyderabad delivers quality education and empowers students with the latest technology. Choose Caddesk Hyderabad for a successful career as a CAD, CAM or CAE professional</p>
